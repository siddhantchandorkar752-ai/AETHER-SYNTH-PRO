...
class Generator(nn.Module):
    """
    Elite DCGAN Generator. 
    Transforms noise into high-fidelity synthetic data.
    """
    def __init__(self):
        ...
        logger.debug("Generator architecture initialized.")
...
class Discriminator(nn.Module):
    ...
    def __init__(self):
        ...
        logger.debug("Discriminator architecture initialized.")
